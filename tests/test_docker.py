...
class TestDockerCompose:
    ...
    @pytest.mark.integration
    @pytest.mark.slow
    def test_development_hot_reload(self, compose: DockerCompose, compose_path: Path):
        """Test hot reload functionality in development mode."""
        # Make a change to a source file
        test_file = Path(compose_path.parent) / "src" / "mcp_server" / "test_marker.py"
...
class TestProductionReadiness:
    ...
    def test_environment_variables_handling(self):
        ...
        _, output = container.exec("printenv DEPLOYMENT_MODE")
